...
SELECT DISTINCT ship_city, ship_country FROM orders ORDER BY ship_city, ship_country
...
SELECT AVG(shipped_date - order_date) as avg_delivery_time_to_Germany FROM orders WHERE ship_country = 'Germany'
